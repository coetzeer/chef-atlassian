default['bpl']['devtool']['name'] = 'bamboo'
default['bpl']['devtool']['user'] = 'bamboo'
default['bpl']['devtool']['install_home'] = '/var/bamboo'
default['bpl']['devtool']['uid'] = 7006
default['bpl']['devtool']['url'] = 'http://hdqwks016.polarlake.com:7001/atlassian/atlassian-bamboo-5.4.1.tar.gz'
