default['bpl']['devtool']['name'] = 'fisheye'
default['bpl']['devtool']['user'] = 'fisheye'
default['bpl']['devtool']['install_home'] = '/var/fisheye'
default['bpl']['devtool']['uid'] = 7005
default['bpl']['devtool']['url'] = 'http://hdqwks016.polarlake.com:7001/atlassian/crucible-3.3.1.zip'
...
default['devtool']['tomcat']['port'] = 8060
